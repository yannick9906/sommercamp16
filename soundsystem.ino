...
//Own Song - Mario Death
int songtest2[] = {
  NOTE_C5, NOTE_CS5, NOTE_D5, 0 ,0,
  NOTE_G4, NOTE_D5, 0, NOTE_D5, NOTE_D5, NOTE_C5, NOTE_B4, NOTE_G4, NOTE_E4, 0, NOTE_E4, NOTE_C4
};
...
void sing(int songnum) {
  switch(songnum){
    case 1:
      // iterate over the notes of the melody:{
      Serial.println("Case 1");
      int size = sizeof(songtest2) / sizeof(int);
      for (int thisNote = 0; thisNote < size; thisNote++) {
        // to calculate the note duration, take one second
        // divided by the note type.
        //e.g. quarter note = 1000 / 4, eighth note = 1000/8, etc.
        int noteDuration = 1000 / songtest2_tempo[thisNote];
   
        buzz(buzzerPin, songtest2[thisNote], noteDuration);
